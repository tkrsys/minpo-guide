...
import { FLOW_SECTIONS } from '@/data/saiken-souron';
import { getLaw } from '@/lib/laws';

const law = getLaw('saiken-souron');
...
export default function SaikenSouronPage() {
  return (
    <div data-theme={law.theme}>
      ...
      <SiteFooter>
        法令根拠：民法 第三編 債権（総則）（e-Gov 法令検索 https://laws.e-gov.go.jp/law/129AC0000000089）
      </SiteFooter>
    </div>
  );
}
