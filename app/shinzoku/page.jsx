...
import { FLOW_SECTIONS } from '@/data/shinzoku';
import { getLaw } from '@/lib/laws';

const law = getLaw('shinzoku');
...
export default function ShinzokuPage() {
  return (
    <div data-theme={law.theme}>
      ...
      <SiteFooter>
        法令根拠：民法 第四編 親族（e-Gov 法令検索 https://laws.e-gov.go.jp/law/129AC0000000089）
      </SiteFooter>
    </div>
  );
}
